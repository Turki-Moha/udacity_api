...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, token, order, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
                    token = jsonwebtoken_1["default"].verify(_req.headers.authorization, process.env.TOKEN_SECRET);
                }
                catch (err) {
                    res.status(401);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                token = jsonwebtoken_1["default"].verify(_req.headers.authorization, process.env.TOKEN_SECRET);
                return [4 /*yield*/, store.show(token.user)];
            case 2:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 4];
