...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, createProducts, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var token, token, product, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
                    token = jsonwebtoken_1["default"].verify(req.headers.authorization, process.env.TOKEN_SECRET);
                }
                catch (err) {
                    res.status(401);
                    res.json('invalid token');
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                token = jsonwebtoken_1["default"].verify(req.headers.authorization, process.env.TOKEN_SECRET);
                return [4 /*yield*/, store.addProduct(req.body.quantity, token.user, req.body.product_id)];
            case 2:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 4];
